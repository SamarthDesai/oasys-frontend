      ...
      <Row type="flex" justify="space-around" gutter={16}>
        <Col type="flex" align="middle">
          <ScrollAnimation animateIn="fadeIn">
            <Icon type="compass" theme="twoTone" style={{ fontSize: "32px" }} />
            <p> Discover the people, groups, and events at your school </p>
          </ScrollAnimation>
        </Col>
        <Col type="flex" align="middle">
          <ScrollAnimation animateIn="fadeIn" delay={500}>
            <Icon type="pushpin" theme="twoTone" style={{ fontSize: "32px" }} />
            <p> Keep track of everything interesting at school </p>
          </ScrollAnimation>
        </Col>
        <Col type="flex" align="middle">
          <ScrollAnimation animateIn="fadeIn" delay={1000}>
            <Icon type="message" theme="twoTone" style={{ fontSize: "32px" }} />
